...
namespace Cotton.Mobile.Resources.Localization
{
    public static class CoreResources
    {
        ...
        public static string DeleteSyncMessage => GetString(nameof(DeleteSyncMessage));
        ...
        public static string DeleteFailedStatus => GetString(nameof(DeleteFailedStatus));
        public static string DeleteSyncTitleFormat => GetString(nameof(DeleteSyncTitleFormat));
        public static string DeletedSyncFormat => GetString(nameof(DeletedSyncFormat));
        ...
        public static string ChooseMediaStatus => GetString(nameof(ChooseMediaStatus));
        public static string ReconnectStatus => GetString(nameof(ReconnectStatus));
        public static string ReconnectMediaStatus => GetString(nameof(ReconnectMediaStatus));
        ...
        public static string ScanningDeviceStatus => GetString(nameof(ScanningDeviceStatus));
        public static string ScanningOneFileStatus => GetString(nameof(ScanningOneFileStatus));
        public static string ScanningFilesFormat => GetString(nameof(ScanningFilesFormat));
        public static string CheckingCloudStatus => GetString(nameof(CheckingCloudStatus));
        public static string ApplyingChangesFormat => GetString(nameof(ApplyingChangesFormat));
        public static string FinishingSyncStatus => GetString(nameof(FinishingSyncStatus));
        public static string UploadingFileFormat => GetString(nameof(UploadingFileFormat));
        public static string UploadingFileWithTotalFormat => GetString(nameof(UploadingFileWithTotalFormat));
        public static string UploadingFileWithSpeedFormat => GetString(nameof(UploadingFileWithSpeedFormat));
        public static string UploadingFileWithTotalAndSpeedFormat => GetString(nameof(UploadingFileWithTotalAndSpeedFormat));
        public static string BytesFormat => GetString(nameof(BytesFormat));
        public static string KilobytesFormat => GetString(nameof(KilobytesFormat));
        public static string MegabytesFormat => GetString(nameof(MegabytesFormat));
        public static string GigabytesFormat => GetString(nameof(GigabytesFormat));
        ...
        public static string SyncFailurePendingUploadChanged => GetString(nameof(SyncFailurePendingUploadChanged));
        public static string SyncFailureRemotePathConflict => GetString(nameof(SyncFailureRemotePathConflict));
        public static string SyncFailureRemoteRevisionChanged => GetString(nameof(SyncFailureRemoteRevisionChanged));
        public static string SyncFailureInvalidLocalItemName => GetString(nameof(SyncFailureInvalidLocalItemName));
        public static string SyncFailureLocalSourceUnavailable => GetString(nameof(SyncFailureLocalSourceUnavailable));
        ...
        public static string ResolvePendingUpload => GetString(nameof(ResolvePendingUpload));
        public static string ResolvePendingUploadTitleFormat => GetString(nameof(ResolvePendingUploadTitleFormat));
        public static string ResolvePendingUploadMessage => GetString(nameof(ResolvePendingUploadMessage));
