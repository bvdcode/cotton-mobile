...
namespace Cotton.Mobile.Services
{
    public class AndroidShareIntentStagingService : IAndroidShareIntentStagingService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            AddStreamExtras(intent, contentResolver, extraction);
            AddClipData(intent, contentResolver, extraction);
        ...
        private static void AddStreamExtras(
            Intent intent,
            ContentResolver? contentResolver,
...
#pragma warning disable CS0618, CA1422
            if (intent.Action == Intent.ActionSend)
            {
                ...
                {
                    AddUri(uri, intent.Type, contentResolver, extraction);
                }
...
#pragma warning restore CS0618, CA1422
        ...
        private static void AddClipData(
            Intent intent,
            ContentResolver? contentResolver,
            ShareItemExtraction extraction)
        {
