...
namespace Cotton.Mobile.Services
{
        ...
        IEnumerable<CottonSyncedFileSnapshot> manifestFiles)
    {
        ...
        public IReadOnlyDictionary<Guid, CottonDeviceToCloudRemoteItemSnapshot> RemoteById { get; } = CreateRemoteIdMap(remoteContent);

        public IReadOnlyDictionary<string, CottonSyncedFileSnapshot> ManifestByPath { get; } = CreateManifestPathMap(manifestFiles);
