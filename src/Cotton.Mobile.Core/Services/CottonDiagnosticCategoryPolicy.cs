    ...
    internal static class CottonDiagnosticCategoryPolicy
    {
        private static readonly Dictionary<string, LogLevel> MinimumLevels =
            new(StringComparer.Ordinal)
            {
                ...
                ["Cotton.Mobile.Services.CottonMediaOriginalRestoreService"] = LogLevel.Information,
                ["Cotton.Mobile.Services.CottonMediaOriginalRestoreExecutor"] = LogLevel.Information,
                ["Cotton.Mobile.ViewModels.SyncSettingsViewModel"] = LogLevel.Warning,
                ["Cotton.Mobile.ViewModels.SyncSettingsExecutionHandler"] = LogLevel.Warning,
                ["Cotton.Mobile.ViewModels.SyncSettingsSetupHandler"] = LogLevel.Warning,
                ["Cotton.Mobile.ViewModels.SyncSettingsLoadingHandler"] = LogLevel.Warning,
                ["Cotton.Mobile.ViewModels.SyncSettingsManagementHandler"] = LogLevel.Warning,
                ["Cotton.Mobile.ViewModels.MediaOriginalRestoreReviewHandler"] = LogLevel.Warning,
