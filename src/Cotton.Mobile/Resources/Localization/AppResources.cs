...
namespace Cotton.Mobile.Resources.Localization
{
    public static class AppResources
    {
        ...
        public static string EnablePhotoBackupText => GetString(nameof(EnablePhotoBackupText));
        public static string EnablePhotoBackupDescription => GetString(nameof(EnablePhotoBackupDescription));
        public static string AddFolderBackupText => GetString(nameof(AddFolderBackupText));
        public static string AddFolderBackupDescription => GetString(nameof(AddFolderBackupDescription));
        ...
        public static string EditSyncsModeTitle => GetString(nameof(EditSyncsModeTitle));
        public static string EnterEditSyncsModeDescription => GetString(nameof(EnterEditSyncsModeDescription));
        public static string ExitEditSyncsModeDescription => GetString(nameof(ExitEditSyncsModeDescription));
        public static string BackgroundSyncRestrictedTitle => GetString(nameof(BackgroundSyncRestrictedTitle));
        public static string BackgroundSyncRestrictedMessage => GetString(nameof(BackgroundSyncRestrictedMessage));
        public static string BackgroundSyncSettingsText => GetString(nameof(BackgroundSyncSettingsText));
        public static string OpenBackgroundSyncSettingsDescription => GetString(nameof(OpenBackgroundSyncSettingsDescription));
        public static string DismissBackgroundSyncRestrictionDescription => GetString(nameof(DismissBackgroundSyncRestrictionDescription));
        public static string SyncSignInRequired => GetString(nameof(SyncSignInRequired));
        public static string SyncTitle => GetString(nameof(SyncTitle));
        public static string NoBackupsTitle => GetString(nameof(NoBackupsTitle));
        public static string NoBackupsBody => GetString(nameof(NoBackupsBody));
        public static string PhotoBackupTitle => GetString(nameof(PhotoBackupTitle));
        public static string PhotoBackupBody => GetString(nameof(PhotoBackupBody));
