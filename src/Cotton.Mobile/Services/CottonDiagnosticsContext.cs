...
{
    public class CottonDiagnosticsContext
    {
        public CottonDiagnosticsContext(
            string? instanceUrl,
            string? profileName,
            string screen,
            string fileLocation,
            ...
            bool hasInternetAccess)
        {
            ...
            {
                throw new ArgumentException("Diagnostics screen is required.", nameof(screen));
            }

            if (string.IsNullOrWhiteSpace(fileLocation))
            {
                throw new ArgumentException("Diagnostics file location is required.", nameof(fileLocation));
            }

            if (string.IsNullOrWhiteSpace(fileViewMode))
            {
                throw new ArgumentException("Diagnostics file view mode is required.", nameof(fileViewMode));
            }

            if (string.IsNullOrWhiteSpace(fileSortMode))
            {
                throw new ArgumentException("Diagnostics file sort mode is required.", nameof(fileSortMode));
            }
