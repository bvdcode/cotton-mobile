...
namespace Cotton.Mobile.Services
{
    public class CottonCloudToDeviceSyncRootRunResult
    {
        ...
        public static CottonCloudToDeviceSyncRootRunResult SkippedUnsupportedLocalRoot(CottonSyncRootSnapshot root)
        {
            ArgumentNullException.ThrowIfNull(root);
            ...
            return new CottonCloudToDeviceSyncRootRunResult(
                ...
                root.CloudFolder.FolderId,
                root.CloudFolder.FolderName,
                CottonCloudToDeviceSyncRootRunStatus.SkippedUnsupportedLocalRoot,
