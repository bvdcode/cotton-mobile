...
namespace Cotton.Mobile.Tests
{
    public class MaterialDesignTokenTests
    {
        ...
        private const string FileBrowserContentGridViewPath = "src/Cotton.Mobile/Controls/FileBrowserContentGridView.cs";
        ...
        public void Secondary_list_screens_use_initial_loading_skeletons()
        {
            ...
            foreach (string screenPath in screenPaths)
            {
                ...
                Assert.Contains("IsSkeletonVisible=\"{Binding IsLoadingPlaceholderVisible}\"", page, StringComparison.Ordinal);
                Assert.DoesNotContain("Style=\"{StaticResource M3MetadataListSkeletonView}\"", page, StringComparison.Ordinal);
                Assert.DoesNotContain("MetadataListSkeletonView IsVisible=", page, StringComparison.Ordinal);
            }
        ...
        public void Folder_picker_screens_use_file_loading_skeletons()
        {
            ...
            Assert.Contains("IsSkeletonVisible=\"{Binding IsLoadingPlaceholderVisible}\"", destinationPickerPage, StringComparison.Ordinal);
            Assert.Contains("DefaultStyleResourceKey = \"M3FileListSkeletonView\"", fileListSkeletonView, StringComparison.Ordinal);
            Assert.DoesNotContain("Style=\"{StaticResource M3FileListSkeletonView}\"", destinationPickerPage, StringComparison.Ordinal);
            Assert.DoesNotContain("FileListSkeletonView IsVisible=", destinationPickerPage, StringComparison.Ordinal);
        }
        ...
        public void Auth_legal_footer_uses_reusable_material_control()
        {
            ...
            Assert.Contains("<controls:AuthLegalFooterView Grid.Row=\"0\"", mainPage, StringComparison.Ordinal);
            Assert.Contains("IsFooterVisible=\"{Binding Display.IsLegalFooterVisible}\"", mainPage, StringComparison.Ordinal);
            ...
            Assert.Contains("DefaultContainerStyleResourceKey = \"M3AuthLegalFooterContainer\"", authLegalFooterView, StringComparison.Ordinal);
            ...
            Assert.Contains("SetDynamicResource(StyleProperty, DefaultContainerStyleResourceKey)", authLegalFooterView, StringComparison.Ordinal);
            ...
            Assert.Contains("<Thickness x:Key=\"M3AuthLegalFooterMargin\">0,0,0,24</Thickness>", spacing, StringComparison.Ordinal);
            Assert.Contains("<Style TargetType=\"controls:AuthLegalFooterView\" x:Key=\"M3AuthLegalFooterContainer\">", styles, StringComparison.Ordinal);
            Assert.Contains("<Setter Property=\"VerticalOptions\" Value=\"End\" />", styles, StringComparison.Ordinal);
            Assert.True(
                mainPage.IndexOf("<controls:AuthLegalFooterView Grid.Row=\"0\"", StringComparison.Ordinal) >
                mainPage.IndexOf("</controls:ScreenScrollBodyView>", StringComparison.Ordinal));
            ...
            Assert.DoesNotContain("<controls:AuthLegalFooterView IsFooterVisible=\"{Binding Display.IsLegalFooterVisible}\"", mainPage, StringComparison.Ordinal);
        ...
        public void Loading_indicator_frames_use_reusable_material_control()
        {
            ...
            Assert.Contains("IsStatusVisible=\"{Binding Display.IsLoadingVisible}\"", mainPage, StringComparison.Ordinal);
            ...
            Assert.False(directVisibilityMatch.Success, "MainPage uses direct LoadingStatusView IsVisible.");
            ...
            Assert.Contains("IsBusy=\"{Binding IsBusy}\"", appLockGatePage, StringComparison.Ordinal);
            Assert.Contains("IsStatusVisibleProperty", loadingStatusView, StringComparison.Ordinal);
            ...
            Assert.Contains(
                ...
                StringComparison.Ordinal);
            Assert.Contains(
                "StatusOpacityAnimationName = \"M3LoadingStatusOpacity\"",
                loadingStatusView,
                StringComparison.Ordinal);
        ...
        public void File_notice_panels_use_reusable_material_control()
        {
            ...
            IReadOnlyDictionary<string, string> noticeIconFrameSetters =
                GetStyleSetters(styles, "M3NoticeIconFrame");
            IReadOnlyDictionary<string, string> noticeIconSetters =
                GetStyleSetters(styles, "M3NoticeIcon");

            Assert.Contains("<controls:NoticePanelView IsPanelVisible=\"{Binding Display.IsFilesNoticeVisible}\"", mainPage, StringComparison.Ordinal);
            ...
            Assert.Contains("DefaultPanelStyleResourceKey = \"M3NoticePanel\"", noticePanelView, StringComparison.Ordinal);
            Assert.Contains("DefaultGridStyleResourceKey = \"M3NoticeGrid\"", noticePanelView, StringComparison.Ordinal);
            Assert.Contains("DefaultIconFrameStyleResourceKey = \"M3NoticeIconFrame\"", noticePanelView, StringComparison.Ordinal);
            Assert.Contains("DefaultIconStyleResourceKey = \"M3NoticeIcon\"", noticePanelView, StringComparison.Ordinal);
            Assert.Contains("DefaultTextStackStyleResourceKey = \"M3NoticeTextStack\"", noticePanelView, StringComparison.Ordinal);
            Assert.Contains("x:Key=\"M3FileNoticePanel\" BasedOn=\"{StaticResource M3NoticePanel}\"", stylesText, StringComparison.Ordinal);
            Assert.Contains("x:Key=\"M3FileNoticeIconFrame\" BasedOn=\"{StaticResource M3NoticeIconFrame}\"", stylesText, StringComparison.Ordinal);
            ...
            Assert.Contains("PanelOpacityAnimationName = \"M3NoticePanelOpacity\"", noticePanelView, StringComparison.Ordinal);
            Assert.Contains("ActionItemOpacityAnimationName = \"M3NoticePanelActionItemOpacity\"", noticePanelView, StringComparison.Ordinal);
            Assert.Contains("OnPanelVisiblePropertyChanged", noticePanelView, StringComparison.Ordinal);
            ...
            Assert.Contains("CompletePanelVisibility", noticePanelView, StringComparison.Ordinal);
        ...
        public void Action_rows_use_reusable_material_control()
        {
            ...
            Assert.Contains("<x:Int32 x:Key=\"M3MotionStatusDuration\">120</x:Int32>", interaction, StringComparison.Ordinal);
            Assert.Contains("DefaultLeadingIconFrameStyleResourceKey = \"M3ActionListItemIconFrame\"", actionListItemView, StringComparison.Ordinal);
            Assert.Contains("x:Key=\"M3ActionListItemIconFrame\" BasedOn=\"{StaticResource M3NeutralThumbnailFrame}\"", styles, StringComparison.Ordinal);
            Assert.DoesNotContain("DefaultLeadingIconFrameStyleResourceKey = \"M3ActivityThumbnailFrame\"", actionListItemView, StringComparison.Ordinal);
        ...
        public void Capture_inbox_action_bar_uses_reusable_material_control()
        {
            ...
            Assert.Equal(1, CountOccurrences(captureInboxPage, "<controls:ActionClusterView Grid.Row=\"2\"\n                                        ClusterStyleResourceKey=\"M3InlineActionCluster\""));
        ...
        public void Capture_destination_current_folder_actions_use_reusable_material_control()
        {
            ...
            Assert.Contains("<controls:SettingsActionHeaderCardView Grid.Row=\"2\"\n                                                   LeadingIconData=\"{x:Static controls:IconPathData.Folder}\"", destinationPickerPage, StringComparison.Ordinal);
        ...
        public void Main_file_list_rows_use_reusable_material_control()
        {
            ...
            Assert.Contains("<controls:MaterialCollectionView IsContentVisible=\"{Binding Display.IsFileListViewVisible}\"", mainPage, StringComparison.Ordinal);
            Assert.Contains("ItemsSource=\"{Binding Display.FileEntries}\"", mainPage, StringComparison.Ordinal);
            Assert.Contains("ItemsLayout=\"{StaticResource M3FileBrowserListItemsLayout}\"", mainPage, StringComparison.Ordinal);
            ...
            Assert.Contains("public class FileListEntryRowView : Grid", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("SetDynamicResource(StyleProperty, \"M3FileListRowGrid\")", fileListEntryRowView, StringComparison.Ordinal);
            ...
            Assert.Contains("ApplyMetadataState()", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("CreateStatusChipState()", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("return (localCopyStatus, true, \"M3LocalCopyChip\", \"M3LocalCopyChipLabel\")", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("return (offlineAttentionStatus, true, \"M3FileAttentionChip\", \"M3ErrorChipLabel\")", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("_titleLabel.Text = title", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("_detailLabel.Text = detail", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("EnsureStatusChip()", fileListEntryRowView, StringComparison.Ordinal);
        ...
        public void File_entry_thumbnails_use_reusable_material_control()
        {
            ...
            Assert.Contains("_thumbnail.SetDynamicResource(StyleProperty, \"M3FilePreviewSurface\")", fileTileEntryCardView, StringComparison.Ordinal);
            ...
            Assert.DoesNotContain("new FileThumbnailView", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("new Border", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("M3FileListThumbnailSurface", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("ApplyThumbnailState()", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("SetThumbnailContent", fileListEntryRowView, StringComparison.Ordinal);
            Assert.DoesNotContain("new FileThumbnailView", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("ApplyThumbnailState()", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("SetThumbnailContent", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.DoesNotContain("_thumbnail.ApplyThumbnailState(", fileListEntryRowView, StringComparison.Ordinal);
            Assert.DoesNotContain("_thumbnail.ApplyThumbnailState(", fileTileEntryCardView, StringComparison.Ordinal);
        ...
        public void File_status_chips_use_reusable_material_control()
        {
            ...
            Assert.Contains("\"M3LocalCopyChip\"", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("\"M3FileAttentionChip\"", fileListEntryRowView, StringComparison.Ordinal);
        ...
        public void Main_file_tile_metadata_uses_reusable_material_control()
        {
            ...
            Assert.Contains("OfflineAttentionStatus=\"{Binding OfflineAttentionStatus}\"", mainPage, StringComparison.Ordinal);
            Assert.Contains("IsOfflineAttentionVisible=\"{Binding IsOfflineAttentionVisible}\"", mainPage, StringComparison.Ordinal);
            Assert.DoesNotContain("new FileTileMetadataView", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("SetDynamicResource(StyleProperty, \"M3FileTileSlotGrid\")", fileTileEntryCardView, StringComparison.Ordinal);
            ...
            Assert.Contains("ApplyMetadataState()", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("_titleLabel.Text = title", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("_detailLabel.Text = detail", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("EnsureStatusChip()", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("CreateStatusChipState()", fileTileEntryCardView, StringComparison.Ordinal);
        ...
        public void Collection_screens_use_reusable_material_collection_control()
        {
            ...
            Assert.Equal(11, CountOccurrences(combinedPages, "<controls:MaterialCollectionView "));
            Assert.Equal(11, CountOccurrences(combinedPages, "<controls:MaterialCollectionView.ItemTemplate>"));
            ...
            Assert.Contains("ItemsLayout=\"{StaticResource M3VerticalCardListItemsLayout}\"", captureDestinationPickerPage, StringComparison.Ordinal);
            Assert.Contains("ItemsLayout=\"{StaticResource M3VerticalCardListItemsLayout}\"", diagnosticsPage, StringComparison.Ordinal);
            ...
            Assert.Contains("ItemsLayout=\"{StaticResource M3VerticalCardListItemsLayout}\"", syncSettingsPage, StringComparison.Ordinal);
            ...
            Assert.Contains("IsContentVisible=\"{Binding IsListVisible}\"", captureDestinationPickerPage, StringComparison.Ordinal);
            ...
            Assert.Contains("IsContentVisible=\"{Binding IsListVisible}\"", syncSettingsPage, StringComparison.Ordinal);
            Assert.Contains("IsContentVisible=\"{Binding IsListVisible}\"", trashPage, StringComparison.Ordinal);
            Assert.Contains("IsContentVisible=\"{Binding IsListVisible}\"", transfersPage, StringComparison.Ordinal);
        ...
        public void Secondary_feed_lists_use_reusable_stacked_items_control()
        {
            ...
            string combinedPages = notificationSettingsPage
                + securitySettingsPage;

            Assert.Equal(3, CountOccurrences(combinedPages, "<controls:StackedItemsView "));
            Assert.Equal(0, CountOccurrences(combinedPages, "IsContentVisible=\"{Binding IsListVisible}\""));
            ...
            Assert.DoesNotContain("<controls:StackedItemsView", captureDestinationPickerPage, StringComparison.Ordinal);
            Assert.DoesNotContain("<controls:StackedItemsView", syncSettingsPage, StringComparison.Ordinal);
            ...
            Assert.DoesNotContain("StackedItemsView IsVisible=", combinedPages, StringComparison.Ordinal);
        ...
        public void Diagnostics_rows_use_reusable_material_control()
        {
            ...
            Assert.DoesNotContain("<controls:StackedItemsView ItemsSource=\"{Binding Sections}\"", diagnosticsPage, StringComparison.Ordinal);
        ...
        public void Dark_viewer_status_overlays_use_reusable_material_control()
        {
            ...
            Assert.Contains("PositionChanged=\"OnMediaPositionChanged\"", mediaViewerPage, StringComparison.Ordinal);
            Assert.Contains("StateChanged=\"OnMediaStateChanged\"", mediaViewerPage, StringComparison.Ordinal);
            ...
            Assert.Contains("StartOverlay.IsOverlayVisible = !_viewModel.IsAudioPreview", mediaViewerPageCodeBehind, StringComparison.Ordinal);
            Assert.Contains("<controls:LayeredContentView x:Name=\"AudioPlayerLayer\"", mediaViewerPage, StringComparison.Ordinal);
            Assert.Contains("GridStyleResourceKey=\"M3AudioPlayerLayer\"", mediaViewerPage, StringComparison.Ordinal);
            Assert.Contains("IsLayerVisible=\"{Binding IsAudioPreview}\"", mediaViewerPage, StringComparison.Ordinal);
            Assert.Contains("<controls:AudioPlayerView x:Name=\"AudioPlayer\"", mediaViewerPage, StringComparison.Ordinal);
            ...
            Assert.Contains("AudioPlayer.Position = normalizedPosition", mediaViewerPageCodeBehind, StringComparison.Ordinal);
            ...
            Assert.Contains("AndroidViewType = AndroidViewType.TextureView", viewerMediaElementView, StringComparison.Ordinal);
        ...
        public void Secondary_content_cards_use_reusable_material_shell()
        {
            ...
            Assert.Contains("new ContentCardView", authSignInPanelView, StringComparison.Ordinal);
            Assert.DoesNotContain("new ContentCardView", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("new Border", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("new ContentCardView", pdfPreviewPageView, StringComparison.Ordinal);
            Assert.Contains("new ContentCardView", settingsActionHeaderCardView, StringComparison.Ordinal);
            ...
            Assert.Contains("DefaultCardStyleResourceKey = \"M3AuthPanel\"", authSignInPanelView, StringComparison.Ordinal);
            Assert.Contains("_card.SetDynamicResource(StyleProperty, \"M3FileTileCard\")", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("DefaultCardStyleResourceKey = \"M3PdfPageSurface\"", pdfPreviewPageView, StringComparison.Ordinal);
        ...
        public void Main_file_entry_actions_use_reusable_material_control()
        {
            ...
            Assert.DoesNotContain("IconButtonStyleResourceKey = \"M3FileTileActionIconButton\"", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("ActionSemanticDescription=\"{Binding Name, StringFormat='Actions for {0}'}\"", mainPage, StringComparison.Ordinal);
            Assert.DoesNotContain("new FileEntryActionButtonView", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("new Button", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("Text = \"\\u22ee\"", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("ConfigureActionButton(_actionButton)", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("MaterialResources.SetThemeColor(", fileListEntryRowView, StringComparison.Ordinal);
            Assert.DoesNotContain("new FileEntryActionButtonView", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("new Button", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("ConfigureActionButton(_actionButton)", fileTileEntryCardView, StringComparison.Ordinal);
        ...
        public void File_entry_metadata_blocks_use_reusable_material_controls()
        {
            ...
            Assert.Contains("LocalCopyStatus=\"{Binding LocalCopyStatus}\"", mainPage, StringComparison.Ordinal);
            Assert.Contains("OfflineAttentionStatus=\"{Binding OfflineAttentionStatus}\"", mainPage, StringComparison.Ordinal);
            Assert.DoesNotContain("new FileListMetadataView", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("new Label", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("M3FileListMetadataGrid", fileListEntryRowView, StringComparison.Ordinal);
            Assert.Contains("EnsureStatusChip()", fileListEntryRowView, StringComparison.Ordinal);
            Assert.DoesNotContain("<controls:FileTileMetadataView", mainPage, StringComparison.Ordinal);
            Assert.DoesNotContain("new FileTileMetadataView", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("new Label", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("M3FileTileTextStack", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("M3FileTileMetadataGrid", fileTileEntryCardView, StringComparison.Ordinal);
            Assert.Contains("EnsureStatusChip()", fileTileEntryCardView, StringComparison.Ordinal);
            ...
            Assert.Contains("_metadata.ApplyMetadataState(", trashListEntryCardView, StringComparison.Ordinal);
            Assert.DoesNotContain("IsTrailingTextVisible = true", trashListEntryCardView, StringComparison.Ordinal);
            Assert.DoesNotContain("_metadata.Title =", trashListEntryCardView, StringComparison.Ordinal);
            Assert.DoesNotContain("_metadata.Detail =", trashListEntryCardView, StringComparison.Ordinal);
            Assert.DoesNotContain("_metadata.TrailingText =", trashListEntryCardView, StringComparison.Ordinal);
            ...
            Assert.Contains("internal void ApplyMetadataState(", fileListMetadataView, StringComparison.Ordinal);
            Assert.Contains("ApplyResolvedVisualState(", fileListMetadataView, StringComparison.Ordinal);
            Assert.Contains("_currentTrailingText", fileListMetadataView, StringComparison.Ordinal);
            ...
            Assert.Contains("IsTrailingChipActuallyVisible", fileListMetadataView, StringComparison.Ordinal);
            Assert.Contains("<x:Int32 x:Key=\"M3MotionStatusDuration\">120</x:Int32>", interaction, StringComparison.Ordinal);
        ...
        public void Secondary_screen_content_grids_use_reusable_material_shell()
        {
            ...
            Assert.Contains("<controls:ScreenShellView>", captureDestinationPickerPage, StringComparison.Ordinal);
            Assert.Contains("<controls:ScreenShellView>", diagnosticsPage, StringComparison.Ordinal);
            ...
            Assert.Contains("<controls:ScreenShellView>", syncSettingsPage, StringComparison.Ordinal);
            ...
            Assert.Contains("<controls:ScreenContentGridView Grid.Row=\"1\">", diagnosticsPage, StringComparison.Ordinal);
            ...
            Assert.DoesNotContain("<Grid Grid.Row=\"1\"\n              RowDefinitions=\"Auto,Auto,*\"", diagnosticsPage, StringComparison.Ordinal);
            ...
            Assert.DoesNotContain("<Grid Grid.Row=\"1\"\n              RowDefinitions=\"Auto,Auto,*\"", syncSettingsPage, StringComparison.Ordinal);
            Assert.DoesNotContain("<Grid Grid.Row=\"1\"\n              RowDefinitions=\"Auto,Auto,*\"", transfersPage, StringComparison.Ordinal);
            Assert.DoesNotContain("<Grid Grid.Row=\"1\"\n              RowDefinitions=\"Auto,Auto,Auto,*\"", captureInboxPage, StringComparison.Ordinal);
            ...
            Assert.DoesNotContain("<controls:ScreenScrollBodyView Grid.Row=\"1\">", captureDestinationPickerPage, StringComparison.Ordinal);
            Assert.DoesNotContain("<controls:ScreenScrollBodyView Grid.Row=\"1\">", diagnosticsPage, StringComparison.Ordinal);
            Assert.DoesNotContain("<controls:ScreenScrollBodyView Grid.Row=\"1\">", syncSettingsPage, StringComparison.Ordinal);
            ...
            Assert.DoesNotContain("<Grid RowDefinitions=\"Auto,*\">", captureDestinationPickerPage, StringComparison.Ordinal);
            Assert.DoesNotContain("<Grid RowDefinitions=\"Auto,*\">", diagnosticsPage, StringComparison.Ordinal);
            ...
            Assert.DoesNotContain("<Grid RowDefinitions=\"Auto,*\">", syncSettingsPage, StringComparison.Ordinal);
            ...
            Assert.DoesNotContain("Style=\"{StaticResource M3ScreenContentGrid}\"", captureDestinationPickerPage, StringComparison.Ordinal);
            Assert.DoesNotContain("Style=\"{StaticResource M3ScreenContentGrid}\"", diagnosticsPage, StringComparison.Ordinal);
            ...
            Assert.DoesNotContain("Style=\"{StaticResource M3ScreenContentGrid}\"", syncSettingsPage, StringComparison.Ordinal);
            Assert.DoesNotContain("Style=\"{StaticResource M3ScreenContentGrid}\"", trashPage, StringComparison.Ordinal);
            Assert.DoesNotContain("Style=\"{StaticResource M3ScreenContentGrid}\"", transfersPage, StringComparison.Ordinal);
        }
        ...
        public void Main_screen_scroll_bodies_use_reusable_material_shell()
        {
            ...
            Assert.Equal(1, CountOccurrences(mainPage, "<controls:ScreenScrollBodyView"));
            ...
            Assert.Equal(1, CountOccurrences(mainPage, "StackStyleResourceKey=\"M3MainContentStack\""));
            Assert.DoesNotContain("<controls:ScreenScrollBodyView StackStyleResourceKey=\"M3MainContentStack\">", mainPage, StringComparison.Ordinal);
        ...
        {
            string mainPage = LoadText(MainPagePath);
            string fileBrowserContentGridView = LoadText(FileBrowserContentGridViewPath);
            string stackedContentView = LoadText(StackedContentViewPath);

            Assert.Contains("public class StackedContentView", stackedContentView, StringComparison.Ordinal);
            Assert.Contains("StackedContentView : MaterialAnimatedContentView", stackedContentView, StringComparison.Ordinal);
            Assert.Contains("public IList<IView> Items => _stack.Children", stackedContentView, StringComparison.Ordinal);
            Assert.Equal(2, CountOccurrences(mainPage, "<controls:StackedContentView"));
            ...
            Assert.Contains("<controls:FileBrowserContentGridView x:Name=\"FileBrowserContent\">", mainPage, StringComparison.Ordinal);
            Assert.Contains("public class FileBrowserContentGridView : Grid", fileBrowserContentGridView, StringComparison.Ordinal);
            Assert.Contains("DefaultGridStyleResourceKey = \"M3FileBrowserContentGrid\"", fileBrowserContentGridView, StringComparison.Ordinal);
            Assert.Contains("RowDefinitions.Add(new RowDefinition { Height = GridLength.Auto })", fileBrowserContentGridView, StringComparison.Ordinal);
            Assert.Contains("RowDefinitions.Add(new RowDefinition { Height = GridLength.Star })", fileBrowserContentGridView, StringComparison.Ordinal);
