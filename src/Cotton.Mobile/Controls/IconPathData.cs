...
namespace Cotton.Mobile.Controls
{
    public static class IconPathData
    {
        ...
        public static Geometry Language => Create("M12 2 C6.5 2 2 6.5 2 12 C2 17.5 6.5 22 12 22 C17.5 22 22 17.5 22 12 C22 6.5 17.5 2 12 2 Z M18.9 8 L16 8 C15.6 6.8 15.1 5.8 14.5 5 C16.4 5.7 17.9 6.8 18.9 8 Z M12 4.1 C12.8 5.2 13.4 6.5 13.8 8 L10.2 8 C10.6 6.5 11.2 5.2 12 4.1 Z M4.3 14 C4.1 13.4 4 12.7 4 12 C4 11.3 4.1 10.6 4.3 10 L7.7 10 C7.6 10.7 7.5 11.3 7.5 12 C7.5 12.7 7.6 13.3 7.7 14 Z M5.1 16 L8 16 C8.4 17.2 8.9 18.2 9.5 19 C7.6 18.3 6.1 17.2 5.1 16 Z M8 8 L5.1 8 C6.1 6.8 7.6 5.7 9.5 5 C8.9 5.8 8.4 6.8 8 8 Z M12 19.9 C11.2 18.8 10.6 17.5 10.2 16 L13.8 16 C13.4 17.5 12.8 18.8 12 19.9 Z M14.2 14 L9.8 14 C9.6 13.4 9.5 12.7 9.5 12 C9.5 11.3 9.6 10.6 9.8 10 L14.2 10 C14.4 10.6 14.5 11.3 14.5 12 C14.5 12.7 14.4 13.4 14.2 14 Z M14.5 19 C15.1 18.2 15.6 17.2 16 16 L18.9 16 C17.9 17.2 16.4 18.3 14.5 19 Z M16.3 14 C16.4 13.3 16.5 12.7 16.5 12 C16.5 11.3 16.4 10.7 16.3 10 L19.7 10 C19.9 10.6 20 11.3 20 12 C20 12.7 19.9 13.4 19.7 14 Z");
