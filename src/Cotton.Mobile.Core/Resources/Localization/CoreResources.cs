...
namespace Cotton.Mobile.Resources.Localization
{
    public static class CoreResources
    {
        ...
        public static string SyncBothWaysAction => GetString(nameof(SyncBothWaysAction));
        public static string ConflictReviewRequired => GetString(nameof(ConflictReviewRequired));
        public static string BlockedReviewRequired => GetString(nameof(BlockedReviewRequired));
        public static string DestructiveReviewRequired => GetString(nameof(DestructiveReviewRequired));
        public static string ConfirmBidirectionalSyncTitle => GetString(nameof(ConfirmBidirectionalSyncTitle));
        public static string SyncAction => GetString(nameof(SyncAction));
        public static string SyncingBothWaysFormat => GetString(nameof(SyncingBothWaysFormat));
        public static string NoBidirectionalFolders => GetString(nameof(NoBidirectionalFolders));
        public static string BidirectionalSyncCurrent => GetString(nameof(BidirectionalSyncCurrent));
        public static string BidirectionalSyncCompletedFormat => GetString(nameof(BidirectionalSyncCompletedFormat));
        public static string NoDestructiveChanges => GetString(nameof(NoDestructiveChanges));
        public static string DestructiveChangesFormat => GetString(nameof(DestructiveChangesFormat));
        public static string RemoveOneLocalFile => GetString(nameof(RemoveOneLocalFile));
        public static string RemoveLocalFilesFormat => GetString(nameof(RemoveLocalFilesFormat));
        public static string TrashOneCloudFile => GetString(nameof(TrashOneCloudFile));
        public static string TrashCloudFilesFormat => GetString(nameof(TrashCloudFilesFormat));
        public static string SyncToDeviceAction => GetString(nameof(SyncToDeviceAction));
        public static string SyncToFolderAction => GetString(nameof(SyncToFolderAction));
        ...
        public static string UploadDirectionUnsupported => GetString(nameof(UploadDirectionUnsupported));
        ...
        public static string CloudToDeviceDirection => GetString(nameof(CloudToDeviceDirection));
        public static string BidirectionalDirection => GetString(nameof(BidirectionalDirection));
        ...
        public static string BidirectionalDownloadedLabel => GetString(nameof(BidirectionalDownloadedLabel));
        public static string BidirectionalRefreshedLocallyLabel => GetString(nameof(BidirectionalRefreshedLocallyLabel));
        public static string BidirectionalRenamedLocallyLabel => GetString(nameof(BidirectionalRenamedLocallyLabel));
        public static string BidirectionalRemovedLocallyLabel => GetString(nameof(BidirectionalRemovedLocallyLabel));
        public static string BidirectionalUploadedLabel => GetString(nameof(BidirectionalUploadedLabel));
        public static string BidirectionalUpdatedInCloudLabel => GetString(nameof(BidirectionalUpdatedInCloudLabel));
        public static string BidirectionalConflictReviewSingular => GetString(nameof(BidirectionalConflictReviewSingular));
        public static string BidirectionalConflictReviewPlural => GetString(nameof(BidirectionalConflictReviewPlural));
        public static string BidirectionalLocalRemovalReviewSingular => GetString(nameof(BidirectionalLocalRemovalReviewSingular));
        public static string BidirectionalLocalRemovalReviewPlural => GetString(nameof(BidirectionalLocalRemovalReviewPlural));
        public static string BidirectionalCloudRemovalReviewSingular => GetString(nameof(BidirectionalCloudRemovalReviewSingular));
        public static string BidirectionalCloudRemovalReviewPlural => GetString(nameof(BidirectionalCloudRemovalReviewPlural));
        ...
        public static string BidirectionalSyncRootCompleted => GetString(nameof(BidirectionalSyncRootCompleted));
        public static string NotBidirectionalDirection => GetString(nameof(NotBidirectionalDirection));
        public static string NotCloudToDeviceDirection => GetString(nameof(NotCloudToDeviceDirection));
