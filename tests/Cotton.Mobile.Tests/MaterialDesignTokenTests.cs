...
namespace Cotton.Mobile.Tests
{
    public class MaterialDesignTokenTests
    {
        ...
        public void Main_file_list_rows_use_reusable_material_control()
        {
            ...
            Assert.Contains("_metadata.ApplyMetadataState(", fileListEntryRowView, StringComparison.Ordinal);
        ...
        public void File_entry_metadata_blocks_use_reusable_material_controls()
        {
            ...
            Assert.Contains("_metadata.ApplyMetadataState(", fileListEntryRowView, StringComparison.Ordinal);
            Assert.DoesNotContain("_metadata.Title =", fileListEntryRowView, StringComparison.Ordinal);
            Assert.DoesNotContain("_metadata.Detail =", fileListEntryRowView, StringComparison.Ordinal);
            Assert.DoesNotContain("_metadata.TrailingText =", fileListEntryRowView, StringComparison.Ordinal);
            Assert.DoesNotContain("_metadata.IsTrailingTextVisible =", fileListEntryRowView, StringComparison.Ordinal);
            Assert.DoesNotContain("_metadata.TrailingChipStyleResourceKey =", fileListEntryRowView, StringComparison.Ordinal);
